...
def get_db_engine(
    ...
    if not db_engine:
        db_engine = create_engine(engine_url+engine_key+'?charset=utf8',pool_size=5,max_overflow=10,pool_timeout=30,pool_recycle=True,pool_pre_ping=True,echo=False) #jqdata?charset=utf8
